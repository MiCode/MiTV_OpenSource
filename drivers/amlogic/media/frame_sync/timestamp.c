...
void timestamp_videodrop_pts_set(u32 pts)
{
	video_drop_pts = pts;
	//pr_info("set video_drop_pts = %x\n", video_drop_pts);
}
EXPORT_SYMBOL(timestamp_videodrop_pts_set);

u32 timestamp_videodrop_pts_get(void)
{
	//pr_info("get video_drop_pts = %x\n", video_drop_pts);
	return video_drop_pts;
}
EXPORT_SYMBOL(timestamp_videodrop_pts_get);
