...
#define SNDRV_PCM_RATE_12000		(1<<15)		/* 12000Hz */
#define SNDRV_PCM_RATE_24000		(1<<16)		/* 24000Hz */
#endif
...
#endif
	struct timespec open_tstamp;    /* call open() timestamp */
	unsigned long xrun_cnt;
	unsigned long suspend_cnt;
	unsigned long pause_cnt;
};
