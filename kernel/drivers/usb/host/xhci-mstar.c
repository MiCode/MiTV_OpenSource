...
static struct hc_driver __read_mostly mstar_plat_xhci_driver;
...
#if defined(XHCI_PHY_MS22)
static void Mstar_U3phy_MS22_init(struct xhci_hcd_mstar *mstar)
{
	uintptr_t U3TOP_base = mstar->u3phy->u3top_base;
	uintptr_t U3PHY_D_base = mstar->u3phy->u3dtop_base;
	uintptr_t U3PHY_A_base = mstar->u3phy->u3atop_base;
	uintptr_t U3PHY_D_EXT_base = mstar->u3phy->u3dtop_ext_base;

	writeb(0x5e, (void*) (U3TOP_base+0x20*2));
//--------------------------------------
//change initial value begin
//--------------------------------------
	writew(0xb900, (void*) (U3PHY_D_EXT_base+0x0C*2));
	writew(0x0040, (void*) (U3PHY_D_EXT_base+0x3A*2));
	writew(0xfb20, (void*) (U3PHY_D_EXT_base+0x30*2));
	writew(0xa900, (void*) (U3PHY_D_EXT_base+0x04*2));
	writew(0x002a, (void*) (U3PHY_D_EXT_base+0x06*2));
//--------------------------------------
//change initial value end
//--------------------------------------
...
//// Setting for 22nm                      //
////=======================================//
	writew(0x07cb, (void*) (U3PHY_D_base+0x12*2));
	writeb(0x07, (void*) (U3PHY_D_base+0x14*2));
	writew(0x2000, (void*) (U3PHY_A_base+0xA0*2));
	writeb(0xe0, (void*) (U3PHY_A_base+0xA8*2));
	writew(0x08c0, (void*) (U3PHY_D_EXT_base+0x28*2));
	writew(0x0000, (void*) (U3PHY_D_base+0x2A*2));
	writew(0x1000, (void*) (U3PHY_A_base+0x0C*2));
	writew(0x0404, (void*) (U3PHY_D_EXT_base));
	writew(0x0803, (void*) (U3PHY_D_EXT_base+0x02*2));
	writew(0x6101, (void*) (U3PHY_D_EXT_base+0x08*2));
	writew(0x0080, (void*) (U3PHY_D_EXT_base+0x1E*2));
	writew(0x0064, (void*) (U3PHY_D_EXT_base+0x0A*2));
	writew(0x3331, (void*) (U3PHY_D_EXT_base+0x36*2));
////=======================================//
//// Setting for 22nm  end                 //
////=======================================//
	writeb(0x00, (void*) (U3PHY_D_EXT_base+0x45*2-1));
	writew(0x0027, (void*) (U3PHY_D_EXT_base+0x40*2));
////////////////////////////
//// 1. SIM ONLY SETING   //
////////////////////////////
	writew(0x0,    (void*) (U3PHY_D_base+0x02*2));
	writew(0x1181, (void*) (U3PHY_D_base+0x08*2));
////////////////////////////////////
...
/////////////////////////
	...
	writeb(0x00, (void*) (U3PHY_D_EXT_base+0x42*2));
	writeb(0x48, (void*) (U3PHY_D_EXT_base+0x44*2));
////Delay 1ms to wait reset completed!
	writeb(0x02, (void*) (U3TOP_base+0x2A*2));
	writeb(0x01,   (void*) (U3PHY_D_base+0xA0*2));		// du
	writeb(0x20, (void*) (U3PHY_D_base+0x45*2-1));
	writeb(0x08,   (void*) (U3PHY_D_base+0x22*2));
	writeb(0x00, (void*) (U3PHY_D_base+0x8F*2-1));
	writeb(0x10, (void*) (U3PHY_A_base+0x2D*2-1));
	writeb(0x03, (void*) (U3PHY_D_base+0x88*2));
	writeb(0x01, (void*) (U3PHY_D_base+0xA0*2));
	writeb(0x01, (void*) (U3PHY_D_base+0xA2*2));

	/* TX eye setting */
	writeb(0x20, (void*) (U3PHY_D_EXT_base+0x1A*2));

#ifdef U3PHY_PN_SWAP
	writeb(readb((void*)(U3PHY_D_base+0x3D*2-1))| 0x1,	(void*)(U3PHY_D_base+0x3D*2-1));
	writeb(readb((void*)(U3PHY_D_base+0x39*2-1))| 0x20,	(void*)(U3PHY_D_base+0x39*2-1));
#endif

	if (mstar->xhc_flag & XHCFLAG_DEGRADATION) {

		printk("\n\n enable XHCFLAG_DEGRADATION \n\n");
		writeb(readb((void *)(U3PHY_D_base+0xB6*2)) | BIT0,
					(void *)(U3PHY_D_base+0xB6*2));
		writew(0x03E5, (void *)(U3PHY_D_base+0x12*2));
		writeb((u8)((readb((void *)(U3PHY_A_base+0xA2*2)) & 0xFC) | 0x1),
					(void *)(U3PHY_A_base+0xA2*2));
		writew(0x10C0, (void *)(U3PHY_D_base+0x8*2));
		writew((readw((void *)(U3PHY_D_base+0xA*2)) & 0xC000) | 0x1F4,
					(void *)(U3PHY_D_base+0xA*2));
		writeb(readb((void *)(U3PHY_D_EXT_base+0x1A*2)) | BIT6,
					(void *)(U3PHY_D_EXT_base+0x1A*2));
		writeb(readb((void *)(U3PHY_D_base+0xFE*2)) | BIT0,
					(void *)(U3PHY_D_base+0xFE*2));
		writeb(readb((void *)(U3PHY_D_EXT_base+0x9*2-1)) & (u8)(~BIT5),
					(void *)(U3PHY_D_EXT_base+0x9*2-1));
		writeb(readb((void *)(U3PHY_D_EXT_base+0x9*2-1)) & (u8)(~BIT6),
					(void *)(U3PHY_D_EXT_base+0x9*2-1));
		writeb(readb((void *)(U3PHY_D_EXT_base+0xA*2)) & (u8)(~BIT2),
					(void *)(U3PHY_D_EXT_base+0xA*2));
		writeb((readb((void *)(U3PHY_D_EXT_base+0x1*2-1)) & 0xE0) | 0x6,
					(void *)(U3PHY_D_EXT_base+0x1*2-1));
		writeb((readb((void *)(U3PHY_A_base+0xD*2-1)) & 0xCF) | 0x10,
					(void *)(U3PHY_A_base+0xD*2-1));
		writeb((readb((void *)(U3PHY_D_EXT_base+0x3*2-1)) & 0xE0) | 0x8,
					(void *)(U3PHY_D_EXT_base+0x3*2-1));
		writeb((u8)((readb((void *)(U3PHY_D_EXT_base+0x36*2)) & 0x8F) | 0x50),
					(void *)(U3PHY_D_EXT_base+0x36*2));
		writeb(0xFF, (void *)(U3PHY_D_EXT_base+0x31*2-1));
		writew(0x0880, (void *)(U3PHY_D_EXT_base+0x28*2));
		writeb((u8)((readb((void *)(U3PHY_A_base+0x12*2)) & 0xCF) | 0x10),
					(void *)(U3PHY_A_base+0x12*2));
		writew(0x0000, (void *)(U3PHY_D_EXT_base+0x1E*2));
	}
...
static void Mstar_U3phy_MS28_init(uintptr_t U3PHY_D_base, uintptr_t U3PHY_A_base, struct xhci_hcd_mstar *mstar)
{
	unsigned int flag = mstar->xhc_flag;
	...
	writew(mstar->u3_ssc->ssc_tx_synth_c0, (void*) (U3PHY_D_base+0xC0*2));
	writeb(mstar->u3_ssc->ssc_tx_synth_c2, (void*) (U3PHY_D_base+0xC2*2));
	writew(mstar->u3_ssc->ssc_tx_synth_c4, (void*) (U3PHY_D_base+0xC4*2));
	writew(mstar->u3_ssc->ssc_tx_synth_c6, (void*) (U3PHY_D_base+0xC6*2));

	// -- TX current ---
	//writeb(0x01, 	(void*) (U3PHY_A_base+0x35*2-1));
	writew(mstar->u3_tx_current->tx_curr_60, (void*) (U3PHY_A_base+0x60*2));
	writew(mstar->u3_tx_current->tx_curr_62, (void*) (U3PHY_A_base+0x62*2));
	writew(mstar->u3_tx_current->tx_curr_64, (void*) (U3PHY_A_base+0x64*2));
	writew(mstar->u3_tx_current->tx_curr_66, (void*) (U3PHY_A_base+0x66*2));
	writew(0x0400,  (void*) (U3PHY_A_base+0x12*2));
	// ---------------
...
static void Mstar_xhc_init(struct xhci_hcd_mstar *mstar)
{
	struct u3phy_addr_base *u3phy_addr = mstar->u3phy;
	unsigned int flag = mstar->xhc_flag;
...
#if defined(XHCI_PHY_MS28)
	Mstar_U3phy_MS28_init(u3phy_addr->u3dtop_base, u3phy_addr->u3atop_base, mstar);
	#if defined(XHCI_2PORTS) && !defined(CONFIG_MSTAR_XUSB_PCIE_PLATFORM)
		Mstar_U3phy_MS28_init(u3phy_addr->u3dtop1_base, u3phy_addr->u3atop1_base, mstar);
	#endif
#elif defined(XHCI_PHY_MS22)
	Mstar_U3phy_MS22_init(mstar);
	...
	if (flag & XHCFLAG_DISABLE_COMPLIANCE)
	...
	// Set port 0 PENDING_HP_TIMEOUT to 4 us
	writeb((readb((void*)(XHCI_base+0x4424)) & ~(BIT1|BIT0)) | BIT1, (void*)(XHCI_base+0x4424));
#if defined(XHCI_2PORTS)
	// Set port 1 PENDING_HP_TIMEOUT to 4 us
	writeb((readb((void*)(XHCI_base+0x4464)) & ~(BIT1|BIT0)) | BIT1, (void*)(XHCI_base+0x4464));
#endif
}
...
static int xhci_mstar_plat_probe(struct platform_device *pdev)
{
	...
	mstar = devm_kzalloc(dev, sizeof(*mstar), GFP_KERNEL);
	if (!mstar)
		return -ENOMEM;

	mstar->dev = dev;

	u3phy_init_addr = devm_kzalloc(dev, sizeof(*u3phy_init_addr), GFP_KERNEL);
	if (!u3phy_init_addr)
		return -ENOMEM;
	...
	u3phy_init_addr->u3dtop_base = _MSTAR_U3PHY_DTOP_BASE;
	u3phy_init_addr->u3atop_base = _MSTAR_U3PHY_ATOP_BASE;
	u3phy_init_addr->u3dtop_ext_base = _MSTAR_U3PHY_DTOP_EXT_BASE;
#elif defined(XHCI_PHY_MS40)
	u3phy_init_addr->u3dtop_base = _MSTAR_U3PHY_DTOP_BASE;
	u3phy_init_addr->u3atop_base = _MSTAR_U3PHY_ATOP_BASE;
#else
...
#if defined(CONFIG_OF)
	compliance_en = of_property_read_bool(node, "compliance-enable");
	if (compliance_en)
		printk(KERN_NOTICE "compliance enabled!\n");
	else
	#if defined(XHCI_DISABLE_COMPLIANCE)
		flag |= XHCFLAG_DISABLE_COMPLIANCE;
	#else
		printk(KERN_NOTICE "marked disable compliance!\n");
	#endif

	u3_degrade_en = of_property_read_bool(node, "degradation-enable");
	if (u3_degrade_en) {
		dev_crit(dev, "degradation enabled!\n");
		flag |= XHCFLAG_DEGRADATION;
	}
	...
	mstar->u3phy = u3phy_init_addr;
	mstar->u3_ssc = devm_kzalloc(dev, sizeof(*mstar->u3_ssc), GFP_KERNEL);
	mstar->u3_tx_current =
		devm_kzalloc(dev, sizeof(*mstar->u3_tx_current), GFP_KERNEL);

#if defined(CONFIG_OF)
	if(!of_property_read_u32_array(node, "ssc", array, 4)) {
		printk(KERN_NOTICE "ssc = 0x%x, 0x%x, 0x%x, 0x%x\n",
			array[0], array[1], array[2], array[3]);
		mstar->u3_ssc->ssc_tx_synth_c0 = array[0];
		mstar->u3_ssc->ssc_tx_synth_c2 = array[1];
		mstar->u3_ssc->ssc_tx_synth_c4 = array[2];
		mstar->u3_ssc->ssc_tx_synth_c6 = array[3];
	} else
#endif
	{
		mstar->u3_ssc->ssc_tx_synth_c0 = XHCI_SSC_TX_SYNTH_SET_C0;
		mstar->u3_ssc->ssc_tx_synth_c2 = XHCI_SSC_TX_SYNTH_SET_C2;
		mstar->u3_ssc->ssc_tx_synth_c4 = XHCI_SSC_TX_SYNTH_STEP_C4;
		mstar->u3_ssc->ssc_tx_synth_c6 = XHCI_SSC_TX_SYNTH_SPAN_C6;
	}

#if defined(CONFIG_OF)
	if(!of_property_read_u32_array(node, "tx-current", array, 4)) {
		printk(KERN_NOTICE "tx-current = 0x%x, 0x%x, 0x%x, 0x%x\n",
			array[0], array[1], array[2], array[3]);
		mstar->u3_tx_current->tx_curr_60 = array[0];
		mstar->u3_tx_current->tx_curr_62 = array[1];
		mstar->u3_tx_current->tx_curr_64 = array[2];
		mstar->u3_tx_current->tx_curr_66 = array[3];
	} else
#endif
	{
		mstar->u3_tx_current->tx_curr_60 = 0x3939 /* 0x3932 */;
		mstar->u3_tx_current->tx_curr_62 = 0x3924 /* 0x3939 */;
		mstar->u3_tx_current->tx_curr_64 = 0x3932;
		mstar->u3_tx_current->tx_curr_66 = 0x3939;
	}

	mstar->xhc_flag = flag;

	Mstar_xhc_init(mstar);
	 ...
	 * Swap it with mstar HCD.
	 */
	mstar->hcd = platform_get_drvdata(pdev);
	platform_set_drvdata(pdev, mstar);
...
#if defined(XHCI_DISABLE_SS_MODE)
	//disable SS mode
	{
		int i;
...
{
	struct xhci_hcd_mstar	*mstar = platform_get_drvdata(dev);
	struct usb_hcd	*hcd = mstar->hcd;
...
{
	struct xhci_hcd_mstar	*mstar = dev_get_drvdata(dev);
	struct usb_hcd		*hcd = mstar->hcd;
	struct xhci_hcd	*xhci = hcd_to_xhci(hcd);
