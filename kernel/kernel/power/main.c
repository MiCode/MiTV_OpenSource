...
static int pm_ignore_wakelock = 1;
...
static int __init str_ignore_wakelock(char *str)
{
    pm_ignore_wakelock = 1;
    return 1;
}

__setup("str_ignore_wakelock", str_ignore_wakelock);

/**
 *  ignore wakelock here only after enter_state() but not affect Android's wakelock mechnanism
 */
int is_wakelock_ignored(void)
{
    return pm_ignore_wakelock;
}
#endif
