...
#define HAVE_floatsihf2 (TARGET_FP_F16INST)
#define HAVE_floatunssihf2 (TARGET_FP_F16INST)
#define HAVE_floatdihf2 (TARGET_FP_F16INST)
#define HAVE_floatunsdihf2 (TARGET_FP_F16INST)
...
#define HAVE_probe_stack_range_si (ptr_mode == SImode)
#define HAVE_probe_stack_range_di (ptr_mode == DImode)
...
#define HAVE_aarch64_combine_internalv4hf (TARGET_SIMD)
...
#define HAVE_aarch64_vcond_internaldidi (TARGET_SIMD)
...
extern rtx        gen_aarch64_combine_internalv4hf        (rtx, rtx, rtx);
...
extern rtx        gen_aarch64_vcond_internaldidi          (rtx, rtx, rtx, rtx, rtx, rtx);
