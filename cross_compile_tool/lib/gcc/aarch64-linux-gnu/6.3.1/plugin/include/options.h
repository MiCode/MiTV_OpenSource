...
enum opt_code
{
  ...
  OPT_time = 1301,                           /* -time */
  OPT_time_ = 1302,                          /* -time= */
  OPT_traditional = 1303,                    /* -traditional */
  OPT_traditional_cpp = 1304,                /* -traditional-cpp */
  OPT_trigraphs = 1305,                      /* -trigraphs */
  OPT_u = 1306,                              /* -u */
  OPT_undef = 1307,                          /* -undef */
  OPT_v = 1308,                              /* -v */
  OPT_version = 1309,                        /* -version */
  OPT_w = 1310,                              /* -w */
  OPT_wrapper = 1311,                        /* -wrapper */
  OPT_x = 1312,                              /* -x */
  OPT_z = 1313,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
